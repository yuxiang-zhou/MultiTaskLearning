...
def one_fold(task, C, path_train, path_test):
    ...
    fname = glob.glob("result_all/{}*.result".format(name))[0]
    ...
    pred = []
    fname = glob.glob("result_all/{}*.pred".format(name))[0]
    with open(fname) as f:
        bData = False
        for l in f.readlines():
...
if __name__ == '__main__':
    ...
    if argc > 3:
        if sys.argv[1] == 'base':
            if argc > 3:
                one_fold(sys.argv[2],sys.argv[3],sys.argv[4], sys.argv[5])
                exit()
        elif sys.argv[1] == 'cv':
            if argc > 3:
                parameter_tunnig(sys.argv[2],sys.argv[3])
                exit()
        elif sys.argv[1] == 'cl':
            if argc > 5:
                cross_labelling(sys.argv[2],sys.argv[3],sys.argv[4], sys.argv[5])
                exit()
    print help
    # print cross_labelling(sys.argv[1],sys.argv[2],sys.argv[3], sys.argv[4])



# if __name__ == '__main__':
    # main program    
    # print one_fold(sys.argv[1],sys.argv[2],sys.argv[3], sys.argv[4])

# if __name__ == '__main__':
#     # main program    
#     print parameter_tunnig(sys.argv[1],sys.argv[2])
