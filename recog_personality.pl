...
$train_arff    = preprocess($train_arff, [1,6375,6376,6377,6377,6378,6379,6380,6381,6382,6383,6384]);
$test_arff     = preprocess($test_arff, [1,6375,6376,6377,6377,6378,6379,6380,6381,6382,6383,6384]);
